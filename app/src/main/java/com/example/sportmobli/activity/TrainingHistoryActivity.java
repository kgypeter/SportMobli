...
public class TrainingHistoryActivity extends AppCompatActivity {
    ...
    private List<TrainingHistoryDisplay> extractTrainingHistory(DataSnapshot snapshot) {
        ...
        for (DataSnapshot historySnapshot : snapshot.getChildren()) {
            ...
            Float totalTimeFloat = historySnapshot.child("totalTime").getValue(Float.class);
            String totalTimeString = "No time available for this session";
            if (totalTimeFloat != null) {
                totalTimeString = totalTimeFloat.toString();
            }
            ...
            trainingHistoryDisplay.setTotalTime(totalTimeString);
            trainingHistoryDisplay.setHrHistory(hrSeries);
            trainingHistoryDisplays.add(trainingHistoryDisplay);
        }
        trainingHistoryDisplays.sort(DateComparatorUtil::compareTrainingHistory);
